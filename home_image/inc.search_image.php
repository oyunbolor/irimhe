          ...
          <form class="form" role="form" action="<?php echo $my_url; ?>" method="post" name="mainform" id="mainform">
            <div class="form-row">
              <div class="form-group row col-md-6">
                <label class="col-md-4 col-form-label"><?php echo _p("HomeSearchColumn1"); ?>:</label>
                <div class="col-md-6">
                  <input type="text" class="form-control" name="search_title" id="search_title" value="<?php echo $search_title;?>"/>
                </div>
              </div>
			  <div class="form-group justify-content-end">
                <button type="submit" class="btn btn-primary" name="searchimagebttn"><i class="fa fa-search"></i> <?php echo _p("SearchButton"); ?></button>
              </div>
