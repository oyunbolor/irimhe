      ...
      <tbody>
        <tr>
          ...
          <td><?php
				...
				?></td>
          <td><button type="submit" class="btn btn-success mb-2" name="insertgrouprolebttn"><i class="fa fa-save"></i> <?php echo _p("SaveButton");?></button>
            <a class="btn btn-warning mb-2" href="<?php echo $my_url.$search_url; ?>"><i class="fa fa-undo"></i> <?php echo _p("UndoButton");?></a></td>
        </tr>
      </tbody>
    </table>
  </form>
