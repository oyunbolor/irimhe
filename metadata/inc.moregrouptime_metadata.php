...
if($metadata_id==1) 
{
	...
	$valueQuery = "count(*) as meta_count, date_part('year', tm_h.action_date) as tm_year, date_part('month', tm_h.action_date) as tm_month, tg.group_name group_name_mn, tg.group_name_en";
	$fromQuery = "FROM ".$schemas.".".$table_name." tm, ".$schemas.".".$table_name."_h tm_h, ".$schemas.".tagroups tg, ".$schemas.".tausergroups tug";
	$groupQuery = "GROUP BY tm_year, tm_month, tg.group_name, tg.group_name_en";
	$sortQuery = "ORDER BY tg.group_name, tm_year DESC, tm_month ASC";
